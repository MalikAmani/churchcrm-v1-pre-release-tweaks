 ...
 *  description : Detailed reports on Ministry members
 *
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="box-header with-border">
                <h3 class="box-title"><?= gettext('Select the Ministry you would like to report') ?>:</h3>
            </div>
            <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <select id="GroupID" name="GroupID" onChange="UpdateRoles();">
                                <?php
                                // Create the Ministry select drop-down
        ...
        echo '<option value="'.$grp_ID.'">'.$grp_Name.'</option>';
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <input type="radio" Name="ReportModel" value="1" checked><?= gettext('Report for Ministry and role selected') ?>
                            <input type="radio" Name="ReportModel" value="2"><?= gettext('Report for any role in Ministry selected') ?>
                            <?php
                            //<input type="radio" Name="ReportModel" value="3"><?= gettext("Report any Ministry and role")
                            ?>
                        </div>
                    </div>
                    <div class="row">
