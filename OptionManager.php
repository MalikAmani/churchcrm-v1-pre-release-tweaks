 ...
 *              : used for Family Roles, Classifications, and Ministry Types
  *
 ******************************************************************************/
...
switch ($mode) {
    ...
    case 'grptypes':
        $noun = gettext('Type');
        $adjplusname = gettext('Ministry Type');
        $adjplusnameplural = gettext('Ministry Types');
        $sPageTitle = gettext('Ministry Types Editor');
        $listID = 3;
        $embedded = false;
        break;
    case 'securitygrp':
        $noun = gettext('Ministry');
        $adjplusname = gettext('Security Ministry');
    ...
    case 'grproles':
        $noun = gettext('Role');
        $adjplusname = gettext('Ministry Member Role');
        $adjplusnameplural = gettext('Ministry Member Roles');
        $sPageTitle = gettext('Ministry Member Roles Editor');
