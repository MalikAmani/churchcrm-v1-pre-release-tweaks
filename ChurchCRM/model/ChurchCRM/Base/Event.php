        ...
        if (null === $this->collKioskAssignments || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collKioskAssignments) {
                    ...
                    $collKioskAssignments = new $collectionClassName;
                    $collKioskAssignments->setModel('\ChurchCRM\KioskAssignment');
        ...
        if (null === $this->collEventAudiences || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collEventAudiences) {
                    ...
                    $collEventAudiences->setModel('\ChurchCRM\EventAudience');
        ...
        if (null === $this->collCalendarEvents || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collCalendarEvents) {
                    ...
                    $collCalendarEvents = new $collectionClassName;
                    $collCalendarEvents->setModel('\ChurchCRM\CalendarEvent');
