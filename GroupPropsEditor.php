...
$sPageTitle = gettext('Ministry Member Properties Editor');

// Get the Ministry and Person IDs from the querystring
...
if (mysqli_num_rows($rsPropList) == 0) {
    ?>
  <form>
    <h3><?= gettext('This group currently has no properties!  You can add them in the Ministry Editor.') ?></h3>
    <BR>
